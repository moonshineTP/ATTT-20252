...
Sau khi giới thiệu các chi tiết cấu trúc tĩnh của X.509, chương này tập trung vào khía cạnh vận hành động: cách PKI nhúng vào các giao thức bảo mật thực tế. Dù là duyệt web qua HTTPS, gửi email mã hóa, hay ký kết văn bản điện tử, hạt nhân của niềm tin luôn nằm ở việc kiểm tra chuỗi chứng chỉ, trạng thái thu hồi và ràng buộc mục đích sử dụng.
...
\begin{figure}[ht]
    \centering
    \reportfig[0.82]{fig_pki_validation.png}
...
Hình~\ref{fig:tls-handshake} mô tả các bước chính trong bắt tay TLS khi máy chủ gửi chứng chỉ và client xác minh chuỗi tin cậy.

\begin{figure}[htbp]
    \centering
    \reportfig{fig_tls_handshake.png}
    \caption{Tóm tắt vai trò chứng chỉ TLS trong bắt tay HTTPS}
