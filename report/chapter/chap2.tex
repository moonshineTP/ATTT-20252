...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/RSA.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/OAEP.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/DH_protocol.png}
