...
\begin{figure}[htbp]
    ...
    \caption{Sơ đồ tạo khóa, mã hóa và giải mã của thuật toán RSA}
...
\begin{figure}[htbp]
    ...
    \caption{Sơ đồ khối quá trình nhào nặn dữ liệu của chuẩn OAEP}
    \label{fig:rsa_oaep}
\end{figure}
% ---------------------------------------
% ---------------------------------------
...
\begin{figure}[htbp]
    ...
    \caption{Sơ đồ luồng trao đổi khóa Diffie-Hellman}
...
\begin{figure}[htbp]
    ...
    \caption{Mô hình tổng quát của quá trình ký số và các kịch bản tranh chấp phát sinh}
