...
Hình~\ref{fig:mitm-attack} minh họa kịch bản tấn công trung gian khi hai bên chỉ trao đổi khóa công khai trực tiếp. Hình~\ref{fig:mitm-vs-pki} tóm tắt cách CA đóng vai trò neo tín nhiệm, giúp client xác minh khóa thuộc về đúng chủ thể thay vì tin vào kênh truyền.

\begin{figure}[htbp]
    \centering
    \reportfig{fig_mitm.png}
    \caption{Tấn công trung gian khi phân phối khóa công khai không có bên tin cậy}
    \label{fig:mitm-attack}
\end{figure}

\begin{figure}[htbp]
    \centering
    \reportfig[0.82]{fig_pki_ca.png}
    \caption{Vai trò của CA trong việc ràng buộc danh tính máy chủ với khóa công khai}
    \label{fig:mitm-vs-pki}
\end{figure}
...
Chương~\ref{chap:crypto} nêu lên lý thuyết mật mã, trả lời cho câu hỏi “Tại sao cần PKI?” thông qua việc trình bày các nền tảng của mật mã đối xứng và bất đối xứng, cũng như các hạn chế còn tồn tại của chúng.
...
Chương~\ref{chap:x509} đi vào làm rõ “Chứng chỉ số được định nghĩa như thế nào?”, trình bày cấu trúc và vai trò của chứng chỉ số X.509 trong việc ràng buộc giữa danh tính và khóa công khai.

Chương~\ref{chap:deploy} giới thiệu thế giới ứng dụng của PKI, với các ví dụ tiêu biểu như HTTPS, chữ ký số và các hệ thống bảo mật khác.

Chương~\ref{chap:opensource} khảo sát các công cụ và nền tảng mã nguồn mở cho phép tự thân triển khai PKI.

Cuối cùng, chương~\ref{chap:challenges} thảo luận về các thách thức hiện tại cũng như xu hướng phát triển trong tương lai của PKI.
