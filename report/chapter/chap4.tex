...
Hình~\ref{fig:x509-structure} tóm tắt ba phần ASN.1 cốt lõi và các trường quan trọng trong \texttt{tbsCertificate}.

\begin{figure}[htbp]
    \centering
    \reportfig{fig_x509.png}
    \caption{Cấu trúc logic của chứng chỉ X.509 v3}
...
\begin{table}[ht]
    ...
    \small
    \begin{tabularx}{\textwidth}{@{} p{0.28\textwidth}p{0.38\textwidth}p{0.28\textwidth} @{}}
        \toprule
...
\begin{table}[ht]
    ...
    \small
    \begin{tabularx}{\textwidth}{@{} p{0.3\textwidth}p{0.35\textwidth}p{0.3\textwidth} @{}}
        \toprule
...
\begin{itemize}
    ...
    \item \textbf{Hỗ trợ xác thực chuỗi:} \texttt{SubjectKeyIdentifier} và \texttt{AuthorityKeyIdentifier} giúp client chọn đúng CA khi có nhiều chứng chỉ trùng tên. \texttt{CRLDistributionPoints} và \texttt{AuthorityInfoAccess} chỉ dẫn phần mềm nơi lấy thông tin thu hồi qua CRL hoặc OCSP~\cite{RFC6960}.
\end{itemize}
...
\begin{table}[ht]
    ...
    \small
    \begin{tabularx}{\textwidth}{@{}p{0.22\textwidth}p{0.4\textwidth}p{0.33\textwidth}@{}}
        \toprule
